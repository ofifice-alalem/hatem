<x-layout title="لوحة التحكم - إدارة الضباط">
    <x-header title="إدارة الضباط" description="إدارة ومتابعة بيانات الضباط في النظام">
        <x-slot name="actions">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-8">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-600">إجمالي الضباط</p>
                <p class="text-3xl font-bold text-gray-900">{{ $persons->total() }}</p>
                <p class="text-xs text-dark-blue-600 mt-1">{{ $category->category_name }}</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
        ...
        <form method="GET" action="{{ route('officers.index') }}" class="p-6">
            <div class="flex flex-wrap gap-4">
                ...
                <div class="flex items-end gap-3">
                    ...
                    <a href="{{ route('officers.index') }}" class="px-6 py-2.5 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition duration-300 flex items-center whitespace-nowrap h-10">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="px-6 py-4 border-b border-gray-100">
            <div class="flex justify-between items-center">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900">قائمة الضباط</h2>
                    <p class="text-sm text-gray-600 mt-1">إدارة ومتابعة بيانات جميع الضباط المسجلين</p>
                </div>
                <div class="text-sm text-gray-600">
                    <span class="font-medium text-gray-900">{{ $persons->total() }}</span> ضابط
                </div>
            </div>
        </div>
                        ...
                        @foreach($persons as $person)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                                    @if($person->rank)
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-dark-blue-100 text-dark-blue-800">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <div class="flex justify-center space-x-1">
                                        <a href="{{ route('officers.edit', $person) }}" 
        ...
        @else
            <div class="text-center py-16">
                ...
                <p class="text-gray-500 mb-6">ابدأ بإضافة أول ضابط في النظام</p>
                <a href="{{ route('officers.create') }}" 
        ...
        <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
            <div class="p-6">
                ...
                <p class="text-gray-700 mb-6">
                    هل أنت متأكد من حذف بيانات الضابط 
    ...
    <script>
        ...
        function confirmDelete() {
            if (currentPersonId) {
                ...
                form.action = `/officers/${currentPersonId}`;
                form.submit();
            }
        }
