<x-layout title="تعديل بيانات الموظف - نظام الإدارة">
    <div class="mb-8">
        <x-breadcrumb :items="[
            ['title' => 'إدارة الموظفين', 'url' => route('employees.index')],
            ['title' => 'تعديل بيانات الموظف']
        ]" />
        <h1 class="text-3xl font-bold text-gray-900">تعديل بيانات الموظف</h1>
        <p class="text-gray-600 mt-1">تعديل بيانات {{ $employee->name }}</p>
    </div>
        ...
        <form action="{{ route('employees.update', $employee->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" name="file_type" value="{{ old('file_type', $employee->file_type) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="file_number" value="{{ old('file_number', $employee->file_number) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="mother_name" value="{{ old('mother_name', $employee->mother_name) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
                ...
                <div>
                    ...
                    <input type="text" name="mother_nationality" value="{{ old('mother_nationality', $employee->mother_nationality) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="personal_card_number" value="{{ old('personal_card_number', $employee->personal_card_number) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
