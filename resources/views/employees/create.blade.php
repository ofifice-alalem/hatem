<x-layout title="إضافة موظف جديد - نظام الإدارة">
    <div class="mb-8">
        <x-breadcrumb :items="[
            ['title' => 'إدارة الموظفين', 'url' => route('employees.index')],
            ['title' => 'إضافة موظف جديد']
        ]" />
        <h1 class="text-3xl font-bold text-gray-900">إضافة موظف جديد</h1>
        <p class="text-gray-600 mt-1">أدخل بيانات الموظف الجديد في النظام</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        <form action="{{ route('employees.store') }}" method="POST" class="space-y-6">
            ...
            <div class="border-t border-gray-200 pt-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">الدرجة الوظيفية</h3>
                
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">الدرجة الوظيفية <span class="text-red-500">*</span></label>
                    <select name="rank_id" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" required>
            ...
            <div class="flex justify-between items-center pt-6 border-t border-gray-100">
                <button type="button" onclick="fillRandomEmployeeData()" 
    ...
    <script>
        function fillRandomEmployeeData() {
            ...
            document.querySelector('input[name="file_type"]').value = 'ملف موظف';
            ...
            const degrees = ['بكالوريوس', 'ماجستير', 'دبلوم', 'إجازة جامعية'];
            ...
            document.querySelector('input[name="leadership"]').checked = Math.random() > 0.8;
        }
    </script>
</x-layout>