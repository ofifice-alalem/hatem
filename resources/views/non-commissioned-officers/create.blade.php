<x-layout title="إضافة ضابط صف جديد - نظام الإدارة">
    <div class="mb-8">
        <x-breadcrumb :items="[
            ['title' => 'إدارة ضباط الصف', 'url' => route('non-commissioned-officers.index')],
            ['title' => 'إضافة ضابط صف جديد']
        ]" />
        <h1 class="text-3xl font-bold text-gray-900">إضافة ضابط صف جديد</h1>
        <p class="text-gray-600 mt-1">أدخل بيانات ضابط الصف الجديد في النظام</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        <form action="{{ route('non-commissioned-officers.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">الرقم العسكري <span class="text-red-500">*</span></label>
            ...
            <div class="flex justify-between items-center pt-6 border-t border-gray-100">
                <button type="button" onclick="fillRandomNCOData()" 
    ...
    <script>
        function fillRandomNCOData() {
            ...
            document.querySelector('input[name="file_type"]').value = 'ملف ضابط صف';
            ...
            document.querySelector('input[name="seniority"]').value = Math.floor(Math.random() * 15) + 1;
            ...
            document.querySelector('input[name="assigned_task"]').value = 'مهام تنفيذية';
            ...
            const degrees = ['بكالوريوس', 'ماجستير', 'دبلوم', 'إعدادية'];
            ...
            document.querySelector('input[name="reviewed"]').checked = Math.random() > 0.4;
            document.querySelector('input[name="leadership"]').checked = Math.random() > 0.6;
        }
    </script>
</x-layout>