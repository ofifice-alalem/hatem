<x-layout title="تعديل بيانات ضابط الصف - نظام الإدارة">
    <div class="mb-8">
        <x-breadcrumb :items="[
            ['title' => 'إدارة ضباط الصف', 'url' => route('non-commissioned-officers.index')],
            ['title' => 'تعديل بيانات ضابط الصف']
        ]" />
        <h1 class="text-3xl font-bold text-gray-900">تعديل بيانات ضابط الصف</h1>
        <p class="text-gray-600 mt-1">تعديل بيانات {{ $nonCommissionedOfficer->name }}</p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
        <form action="{{ route('non-commissioned-officers.update', $nonCommissionedOfficer->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" name="file_type" value="{{ old('file_type', $nonCommissionedOfficer->file_type) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="file_number" value="{{ old('file_number', $nonCommissionedOfficer->file_number) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
                ...
                <div>
                    ...
                    <input type="text" name="national_id" value="{{ old('national_id', $nonCommissionedOfficer->national_id) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name', $nonCommissionedOfficer->name) }}" 
                       class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="date" name="birth_date" value="{{ old('birth_date', $nonCommissionedOfficer->birth_date?->format('Y-m-d')) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">مكان الميلاد</label>
                    <input type="text" name="birth_place" value="{{ old('birth_place', $nonCommissionedOfficer->birth_place) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="gender" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
                        ...
                        <option value="ذكر" {{ old('gender', $nonCommissionedOfficer->gender) == 'ذكر' ? 'selected' : '' }}>ذكر</option>
                        <option value="أنثى" {{ old('gender', $nonCommissionedOfficer->gender) == 'أنثى' ? 'selected' : '' }}>أنثى</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="blood_type" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all">
                        ...
                        <option value="A+" {{ old('blood_type', $nonCommissionedOfficer->blood_type) == 'A+' ? 'selected' : '' }}>A+</option>
                        <option value="A-" {{ old('blood_type', $nonCommissionedOfficer->blood_type) == 'A-' ? 'selected' : '' }}>A-</option>
                        <option value="B+" {{ old('blood_type', $nonCommissionedOfficer->blood_type) == 'B+' ? 'selected' : '' }}>B+</option>
                        <option value="B-" {{ old('blood_type', $nonCommissionedOfficer->blood_type) == 'B-' ? 'selected' : '' }}>B-</option>
                        <option value="AB+" {{ old('blood_type', $nonCommissionedOfficer->blood_type) == 'AB+' ? 'selected' : '' }}>AB+</option>
                        <option value="AB-" {{ old('blood_type', $nonCommissionedOfficer->blood_type) == 'AB-' ? 'selected' : '' }}>AB-</option>
                        <option value="O+" {{ old('blood_type', $nonCommissionedOfficer->blood_type) == 'O+' ? 'selected' : '' }}>O+</option>
                        <option value="O-" {{ old('blood_type', $nonCommissionedOfficer->blood_type) == 'O-' ? 'selected' : '' }}>O-</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="mother_name" value="{{ old('mother_name', $nonCommissionedOfficer->mother_name) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
                ...
                <div>
                    ...
                    <input type="text" name="mother_nationality" value="{{ old('mother_nationality', $nonCommissionedOfficer->mother_nationality) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="personal_card_number" value="{{ old('personal_card_number', $nonCommissionedOfficer->personal_card_number) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
                ...
                <div>
                    ...
                    <input type="text" name="passport_number" value="{{ old('passport_number', $nonCommissionedOfficer->passport_number) }}" 
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" 
